...
% This part will first define the problem to be considered in a concise way, then describe the existing solutions in general to set the context of the parallel bit counting algorithm, which the rest of the project will focus on.
