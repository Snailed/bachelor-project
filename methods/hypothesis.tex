...
\end{hypothesis}
To reject this hypothesis, we are interested in measuring the actual running time on some kind of data and compare the results to some basis model. % TODO: Skal jeg overhovedet have denne her del?
