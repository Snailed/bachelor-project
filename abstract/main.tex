...
\begin{abstract}
    ...
    Then the focus will be shifted to the most recent advances by \citet{fast-similarity-search}, who presents a parallel bit-counting algorithm that supposedly can make the query time sublinear to the amount of sets in $\mathcal{F}$. \\
    This project investigates the efficiency of counting bits in parallel by evaluating the algorithm in terms of time complexity, proof of correctness and an empirical comparison to simpler methods.
